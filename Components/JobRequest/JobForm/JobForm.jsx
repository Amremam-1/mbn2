...
const JobForm = () => {
  ...
  return (
    <section className={styles.jobForm}>
      ...
      {errorForm && <Error errMsg={errorForm} />}
      <div className={`${styles.container} secContainer`}>
        ...
        <form className={styles.form} onSubmit={onSubmit}>
          ...
          {/* <label className={styles.secBoxLabel}>إضافة صورة شخصية</label>
          <div className={styles.secBox}>
            <UploadImage
              id="ContractImg"
              label="إختر صورة شخصية"
              ...
              name="profile_photo"
              value={profile_photo}
              onChange={onChangeProfile_photo}
              onBlur={onBlurProfile_photo}
              errorMsg={profile_photoError}
            />
          </div> */}
          ...
          <label className={styles.secBoxLabel}>
            هل لديك أصحاب من غير الأقارب يعملون في شركتنا ؟
          </label>
          <div className={styles.secBox2}>
            <RadioInput
          ...
          <label className={styles.secBoxLabel}>
            إذا كان لديك أصحاب من غير الأقارب يعملون في شركتنا (أذكرهم)
          </label>
          <div className={styles.secBox}>
            <InputBox
              id="relatives"
          ...
          <label className={styles.secBoxLabel}>
            المعرفون: أذكر أسماء ثلاث أشخاص (من غير الأقارب )
          </label>
          ...
          <label className={styles.secBoxLabel}>
            هل هناك معلومات أخرى تود اضافتها؟
          </label>
          <div className={styles.secBox}>
            <InputBox

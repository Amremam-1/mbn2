...
const useSendJobFormData = () => {
  ...
  // profile_photo: Yup.mixed().required("الصورة الشخصية مطلوبه"),
  ...
  const JobFormSchema = Yup.object().shape({
    ...
    favorite_city_0: Yup.string(),
    favorite_city_1: Yup.string(),
    favorite_city_2: Yup.string(),
    date_of_birth: Yup.string(),
    place_of_birth: Yup.string(),
    nationality: Yup.string(),
    religion: Yup.number(),
    no_of_id: Yup.string(),
    id_place_of_issue: Yup.string(),
    id_date_of_issue: Yup.string(),
    no_of_passport: Yup.string(),
    passport_place_of_issue: Yup.string(),
    passport_date_of_issue: Yup.string(),
    home_phone_no: Yup.string(),
    work_phone_no: Yup.string(),
    ...
    employed_here_before: Yup.boolean(),
    employed_now: Yup.boolean(),
    G_O_S_I_no: Yup.string(),
    min_salary: Yup.number(),
    suitable_work_time_from: Yup.string(),
    suitable_work_time_to: Yup.string(),
    prefered_start_work: Yup.string(),
    work_outside_your_city: Yup.boolean(),
    have_car: Yup.boolean(),
    car_Type: Yup.string(),
    year_of_manufacturing: Yup.string(),
    licence_category: Yup.string(),
    licence_number: Yup.string(),
    licence_date_of_issue: Yup.string(),
    licence_date_of_expiry: Yup.string(),
    licence_place_of_issue: Yup.string(),
    blood_group: Yup.string(),
    have_convicted: Yup.boolean(),
    convict_description: Yup.string(),
    // hobbies_skills: Yup.string().required('برجاء إدخال المهارا وت الهوايات'),
    how_know_job: Yup.string(),
    have_employed_relatives: Yup.boolean(),
    other_data_to_add: Yup.string(),
    education: Yup.string(),
    name_of_institute: Yup.string(),
    education_city: Yup.string(),
    duration_study_from: Yup.string(),
    duration_study_to: Yup.string(),
    specialize: Yup.string(),
    grade: Yup.string(),
    previous_work_0_job_title: Yup.string(),
    previous_work_0_company_name: Yup.string(),
    previous_work_0_start_date: Yup.string(),
    previous_work_0_end_date: Yup.string(),
    previous_work_0_company_address: Yup.string(),
    previous_work_0_company_mobile: Yup.string(),
    previous_work_0_salary: Yup.string(),
    previous_work_0_allowance: Yup.string(),
    previous_work_0_description_of_duties: Yup.string(),
    previous_work_0_reason_for_quit: Yup.string(),
    AR_speaking: Yup.number(),
    AR_reading: Yup.number(),
    AR_writing: Yup.number(),
    ...
    EN_speaking: Yup.number(),
    EN_reading: Yup.number(),
    EN_writing: Yup.number(),
    ...
    Courses_0_name_of_institute: Yup.string(),
    Courses_0_education_city: Yup.string(),
    Courses_0_duration_study_from: Yup.string(),
    Courses_0_duration_study_to: Yup.string(),
    Courses_0_specialize: Yup.string(),
    Identifiers_0_name: Yup.string(),
    Identifiers_0_position: Yup.string(),
    Identifiers_0_company: Yup.string(),
    Identifiers_0_mobile: Yup.string(),
    Identifiers_0_address: Yup.string(),
...
// ---------------------
  let profile_photo;
  let profile_photoError;
  let onChangeProfile_photo;
  let onBlurProfile_photo;

  profile_photo = formik.values.profile_photo;
  profile_photoError = formik.touched.profile_photo && formik.errors.profile_photo ? formik.errors.profile_photo : null;
  onChangeProfile_photo = (e) =>
    {
      formik.setFieldValue("profile_photo", e.currentTarget.files[0]);
      console.log("profile_photo: ---- ", e.currentTarget.files[0])
    }
  onBlurProfile_photo = formik.handleBlur;
